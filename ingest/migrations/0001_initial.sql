...
--
--CREATE TABLE "ingest_project" ("id" serial NOT NULL PRIMARY KEY, "name" varchar(256) NOT NULL, "funded_by" varchar(256) NOT NULL, "is_biccn" boolean NOT NULL);
--
-- Create model UUID
--
...
--
CREATE TABLE "ingest_datagroup" ("id" serial NOT NULL PRIMARY KEY, "dataset_uuid1_id" integer NOT NULL, "project_id_id" integer NULL);
--
...
ALTER TABLE "ingest_project" ("name" varchar(256) NOT NULL);
--CREATE INDEX "ingest_descriptivemetadata_user_id_7f0b3940" ON "ingest_descriptivemetadata" ("user_id");
ALTER TABLE "ingest_datagroup" ADD CONSTRAINT "ingest_datagroup_dataset_uuid1_id_66992cf0_fk_ingest_de" FOREIGN KEY ("dataset_uuid1_id") REFERENCES "ingest_descriptivemetadata" ("id") DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE "ingest_datagroup" ADD CONSTRAINT "ingest_datagroup_project_id_id_054bfa52_fk_ingest_project_id" FOREIGN KEY ("project_id_id") REFERENCES "ingest_project" ("id") DEFERRABLE INITIALLY DEFERRED;

CREATE INDEX "ingest_datagroup_dataset_uuid1_id_66992cf0" ON "ingest_datagroup" ("dataset_uuid1_id");
CREATE INDEX "ingest_datagroup_project_id_id_054bfa52" ON "ingest_datagroup" ("project_id_id");
