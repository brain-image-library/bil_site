...
urlpatterns = [
    ...
    re_path(r'^collection/sendValidation/$', views.sendValidation, name = 'sendValidation'),
    path('collection_cwl_validation_results/<int:pk>', views.collection_cwl_validation_results, name = 'collection_cwl_validation_results')
]
